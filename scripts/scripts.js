...
// INSERT YOUR CODE HERE
{
    let changeration = document.getElementById("duration-button");

    var changeDuration = function() {
        let ccc = document.getElementById("duration-text");
        let bbb = prompt("how many days");
        duration = parseInt(bbb) ;
        ccc.innerHTML = duration;
        recalculate();
    };

    changeration.addEventListener("click", changeDuration);
}
